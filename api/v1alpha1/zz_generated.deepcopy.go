...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AirflowUIAuthentication) DeepCopyInto(out *AirflowUIAuthentication) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AirflowUIAuthentication.
func (in *AirflowUIAuthentication) DeepCopy() *AirflowUIAuthentication {
	if in == nil {
		return nil
	}
	out := new(AirflowUIAuthentication)
	in.DeepCopyInto(out)
	return out
}
